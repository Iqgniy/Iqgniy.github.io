...
![](https://raw.githubusercontent.com/Iqgniy/Iqgniy.github.io/master/img/readme-home.png)
...
SEOTitle: XX的博客 | BY Blog		# SEO 标题
description: "Hey"	   	   # 随便说点，描述一下

# SNS settings      
github_username: xxxx     # 你的github账号
jianshu_username: xxxxxx  # 你的简书ID。
...
看右边:
![](https://raw.githubusercontent.com/Iqgniy/Iqgniy.github.io/master/img/readme-side.png)
...
ga_domain: xxxxxxxx			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
...
我的博客标题是 **“哪里找这么好”** 但是我想要在搜索的时候显示 **“Where | Blog”** ，这个就需要 SEO Title 来定义了。
...
1.感谢两位[Hux](https://github.com/Huxpro/huxpro.github.io) 、[qiubaiying](https://github.com/qiubaiying/qiubaiying.github.io), 感谢作者。 
2. 感谢 Jekyll、Github Pages 和 Bootstrap!

## License

遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/iqgniy/iqgniy.github.io/blob/master/LICENSE)。
